...
export const featureIntro = [
  ...
  'RocketScanner can automate the process of gathering this data, but it will be up to you to interpret the results and draw conclusions.',
];

export const about = [
  `RocketScanner is a powerful all-in-one tool for discovering information about a website/host.
The core philosophy is simple: feed RocketScanner a URL and let it gather, collate, and present a broad array of open data for you to delve into.`,
...
export const license = `RocketScanner — Analyze any website.`;

export const supportUs = [
  'RocketScanner is free to use.',
  "Want to grow your business? <a href='https://www.gohighlevel.com/affiliate-30trial?fp_ref=30dayfreetrialrl'>Try GoHighLevel free for 30 days</a>.",
  "Have questions or want to connect with others? <a href='https://www.skool.com/rocketlauncher-university'>Join our free community</a>.",
];
